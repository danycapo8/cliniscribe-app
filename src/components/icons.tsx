...
// Icono CRÍTICO / SEGURIDAD (Escudo)
...
// Icono PRECAUCIÓN / ADVERTENCIA (Triángulo)
...
// Icono ÉXITO / FORTALEZA (Círculo Check)
...
// Icono SUGERENCIA / IDEA (Bombilla)
...
// --- NUEVO: ISOTIPO ANIMADO (Loader de Marca) ---
export const IsotypeIcon = ({ className }: { className?: string }) => (
